...
checks=[('examples',['python','scripts/validate_examples.py']),('bindings',['python','scripts/validate_bindings.py']),('test-vectors',['python','scripts/validate_test_vectors.py']),('yaml-models',['python','scripts/validate_yaml_models.py']),('graphs',['python','scripts/validate_tsmm_graph.py']),('registry',['python','scripts/validate_tsmm_registry.py']),('docs',['python','scripts/check_docs.py']),('coverage',['python','scripts/check_schema_coverage.py']),('governance',['python','scripts/validate_repository_governance.py']),('relationships',['python','scripts/validate_portfolio_relationships.py'])]
out=[]
for i,cmd in checks:
